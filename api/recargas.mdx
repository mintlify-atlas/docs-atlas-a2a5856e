...
description: "Top up customer mobile lines and inject operator balances for Tigo, Entel, and Viva through the Kantuta POS Recargas API, linked to active cashier sessions."
---
...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/recargas/operadoras/saldos \
...
<CodeGroup>
```bash curl
curl -X POST https://api.kantuta.com/recargas/cliente \
  -H "Authorization: Bearer <access_token>" \
...
<CodeGroup>
```bash curl
curl -X POST https://api.kantuta.com/recargas/inyeccion \
  -H "Authorization: Bearer <access_token>" \
  -H "Content-Type: application/json" \
  -d '{
...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/recargas/historial/clientes \
  -H "Authorization: Bearer <access_token>"
```
...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/recargas/historial/inyecciones \
  -H "Authorization: Bearer <access_token>"
```
