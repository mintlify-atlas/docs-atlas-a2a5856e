...
description: "Complete reference for the Kantuta POS NestJS REST API: base URL configuration, authentication conventions, public endpoints, token refresh, and all available modules."
---
