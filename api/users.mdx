...
sidebarTitle: "Users"
description: "Register users with linked persona records, list and update accounts, manage personal details, and send transactional emails via the Kantuta POS API."
---
