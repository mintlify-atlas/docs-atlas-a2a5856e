...
description: "Complete TypeScript interface reference for all Kantuta POS API entities — base types, inventory, operations, agents, and recargas — organized for quick lookup."
---
