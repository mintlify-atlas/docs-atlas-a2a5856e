...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/cajas \
...
<CodeGroup>
```bash curl
curl -X POST https://api.kantuta.com/cajas \
  -H "Authorization: Bearer <access_token>" \
...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/cajas/1 \
  -H "Authorization: Bearer <access_token>"
```
...
<CodeGroup>
```bash curl
curl -X PATCH https://api.kantuta.com/cajas/1 \
  -H "Authorization: Bearer <access_token>" \
  -H "Content-Type: application/json" \
...
<CodeGroup>
```bash curl
curl -X DELETE "https://api.kantuta.com/cajas/1?id_user_update=2" \
  -H "Authorization: Bearer <access_token>"
```
...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/cajas/sesion-activa/5 \
  -H "Authorization: Bearer <access_token>"
```
...
<CodeGroup>
```bash curl
curl -X POST https://api.kantuta.com/cajas/abrir \
  -H "Authorization: Bearer <access_token>" \
  -H "Content-Type: application/json" \
  -d '{
    "id_caja": 1,
...
<CodeGroup>
```bash curl
curl -X PATCH https://api.kantuta.com/cajas/sesion/12/cerrar \
  -H "Authorization: Bearer <access_token>" \
  -H "Content-Type: application/json" \
  -d '{
...
<CodeGroup>
```bash curl
curl -X GET https://api.kantuta.com/cajas/sesion/12/balance \
  -H "Authorization: Bearer <access_token>"
```
...
<CodeGroup>
```bash curl
curl -X POST https://api.kantuta.com/cajas/movimiento \
  -H "Authorization: Bearer <access_token>" \
  -H "Content-Type: application/json" \
  -d '{
    "tipo": "EGRESO",
